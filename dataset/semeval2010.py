...
class SemEval2010(Dataset):
    ...
    def __init__(self, path="dataset/SemEval2010_full/test/", include_abs=False,
    ...
    def __str__(self):
        if self.include_abs:
            return "SemEval (with abstracts) at " + self.docs_path
        else:
            return "SemEval (without abstracts) at " + self.docs_path
...
class SemEvalDoc(Document):
    ...
    def __str__(self) -> str:
        return "SemEval document at " + self.doc_path
